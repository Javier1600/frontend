...
class CompanyExploreCompanyProfile extends StatefulWidget {
  Company company;
  Company reqCompany;
  CompanyExploreCompanyProfile(this.company, this.reqCompany, {super.key});

  @override
  State<CompanyExploreCompanyProfile> createState() => _CompanyProfileState();
}

class _CompanyProfileState extends State<CompanyExploreCompanyProfile> {
  @override
