...
class AdminPostulations extends StatefulWidget {
  User user;
  AdminPostulations(this.user, {super.key});

  @override
  State<AdminPostulations> createState() => _AdminPostulationsState();
}
...
class _AdminPostulationsState extends State<AdminPostulations> {
  ...
  void initState() {
    jobs = getAllJobs();
    userPostulations = getAllPostulations();
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(
                                ...
                                return homePageAdmin(widget.user);
                              }));
                            },
                            child: Text(
                              "Inicio",
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(
                                  MaterialPageRoute<Null>(
                                      builder: (BuildContext context) {
                                return AdminProfile(widget.user);
                              }));
                            },
                            child: Text(
                              "Mi perfil",
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(
                                  MaterialPageRoute<Null>(
                                      builder: (BuildContext context) {
                                return AdminPostulations(widget.user);
                              }));
                            },
                            child: Text(
                              "Postulaciones",
...
List<Widget> Postulations(List<Job>? jobs, List<Postulation>? Posts,
    List<Company>? companies, List<User>? users, User user, context) {
  List<Widget> pRet = [];
  for (Postulation post in Posts!) {
    User? usr;
    for (User u in users!) {
      if (u.id == post.idUsuario) {
        usr = u;
        break;
      }
    }
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute<void>(
                            builder: (BuildContext context) {
                          return userProfileUser(user, usr!, true, false);
                        }));
                      },
                    ),
                    IconButton(
