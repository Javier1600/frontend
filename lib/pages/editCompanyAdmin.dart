...
class EditCompanyAdmin extends StatefulWidget {
  User admin;
  Company reqCompany;
  EditCompanyAdmin(this.admin, this.reqCompany, {super.key});

  @override
  State<EditCompanyAdmin> createState() => _EditCompanyAdminState();
}

class _EditCompanyAdminState extends State<EditCompanyAdmin> {
              ...
              onPressed: () {
                if (navigate) {
                  Navigator.of(context).push(
                    ...
                    return ExplorePageAdmin(widget.admin);
                  }));
                } else {
