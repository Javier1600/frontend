...
class EditExternalCompany extends StatefulWidget {
  User loggedUser;
  ExternalCompany eCompany;
  EditExternalCompany(this.loggedUser, this.eCompany, {super.key});

  @override
  State<EditExternalCompany> createState() => _AddJobState();
}

class _AddJobState extends State<EditExternalCompany> {
  ...
  @override
  void initState() {
    nombreEmpresa = widget.eCompany.nombreEmpresa;
    descripcionPublicacion = widget.eCompany.descripcionPublicacion;
    url = widget.eCompany.url;
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          TextFormField(
                            initialValue: descripcionPublicacion,
                            minLines: 1,
                            maxLines: 10,
                                    ...
                                    if (nombreEmpresa != "" &&
                                      ...
                                      ExternalCompany newExternal =
                                          ExternalCompany(
                                              ...
                                              url: url,
                                              v: 0);
                                      editExternalCompany(newExternal);
                                      AddAlert(
                                          "Exito",
                                          "Se ha guardaddo la publicacion de forma exitosa",
                                          true);
                                    } else {
                                      print(
