...
class EditJob extends StatefulWidget {
  Company company;
  Job job;
  EditJob(this.company, this.job, {super.key});
...
class _EditJobState extends State<EditJob> {
  ...
  @override
  void initState() {
    puesto = widget.job.puesto;
    descripcion = widget.job.descripcion;
    formacionAcademica = widget.job.formacionAcademica;
    experiencia = widget.job.experiencia;
    conocimientos = widget.job.conocimientos;
    modalidad = widget.job.modalidad;
    modalidad == "Presencial"
        ? isPresential = true
        : modalidad == "Virtual"
            ? isVirtual = true
            : isHybride = true;
    aptitudes = widget.job.aptitudes;
    numeroVacantes = widget.job.numeroVacantes;
    super.initState();
  }
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      initialValue: formacionAcademica,
                      minLines: 1,
                      maxLines: 10,
                      decoration: InputDecoration(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              if (puesto != "" &&
                                ...
                                AddAlert(
                                    "Exito",
                                    "Se ha actualizado el empleo de forma exitosa",
                                    true);
                              } else {
