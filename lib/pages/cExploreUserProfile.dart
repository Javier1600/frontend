...
class CompanyExploreUserProfile extends StatefulWidget {
  //Variables para construir el drawer y el perfil
  User reqUser;
  Company company;
  CompanyExploreUserProfile(this.reqUser, this.company, {super.key});

  @override
  State<CompanyExploreUserProfile> createState() => _userProfileCompanyState();
}
...
class _userProfileCompanyState extends State<CompanyExploreUserProfile> {
